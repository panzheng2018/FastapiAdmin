...
const {
  ...
  core: {
    ...
    columnsFactory: (): ColumnOption<ProduceCraftTable>[] => [
      ...
      { prop: "parent_id", label: "父工艺ID", minWidth: 120, showOverflowTooltip: true, headerAlign: "center" },
      { prop: "name", label: "工艺名称", minWidth: 120, showOverflowTooltip: true, headerAlign: "center" },
      {
        prop: "status",
        label: "状态",
        width: 88,
